 ...
 * <p>
 * Typical implementations are {@link de.fuberlin.wiwiss.d2rq.algebra.Attribute} (describing the set
 * of strings contained in one database column), {@link de.fuberlin.wiwiss.d2rq.values.Pattern}
 * (describing the set of strings that is obtained by sticking
 * the values of several database fields into a string pattern),
 * and {@link de.fuberlin.wiwiss.d2rq.values.BlankNodeID} (similar).
 * <p>
 ...
 * pattern. This includes {@link de.fuberlin.wiwiss.d2rq.map.TranslationTable}.TranslatingValueSource
...
public interface ValueMaker {
	 ...
	 * produces the specified value. {@link de.fuberlin.wiwiss.d2rq.expr.Expression#FALSE} if this
	...
	/**
	 * Returns a set of all {@link de.fuberlin.wiwiss.d2rq.algebra.ProjectionSpec}s containing data necessary
	 * for this ValueSource.
	 * @return a set of {@link de.fuberlin.wiwiss.d2rq.algebra.ProjectionSpec}s
	 */
