...
public final class TransformExprToSQLApplyer implements ExprVisitor {
	 ...
	 * 
	 * @param expr The root node of an {@link com.hp.hpl.jena.sparql.expr.Expr Expr} tree, contains the SPARQL filter.
	 * @param nodeRelation The relation supplying the values to apply the filter on.
	 * @return The root node of an {@link de.fuberlin.wiwiss.d2rq.expr.Expression Expression} tree, if conversion was successful, <code>null</code> otherwise.
	 */
