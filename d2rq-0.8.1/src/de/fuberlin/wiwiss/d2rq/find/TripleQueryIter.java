...
/**
 * Wraps a {@link com.hp.hpl.jena.sparql.engine.iterator.QueryIter} over bindings with three s/p/o variables
 * (see {@link de.fuberlin.wiwiss.d2rq.algebra.TripleRelation}) as an iterator over {@link com.hp.hpl.jena.graph.Triple}s.
