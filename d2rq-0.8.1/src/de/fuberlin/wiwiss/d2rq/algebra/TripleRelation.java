...
/**
 * A collection of virtual triples obtained by applying a {@link de.fuberlin.wiwiss.d2rq.algebra.Relation} to a
 * database, and applying {@link de.fuberlin.wiwiss.d2rq.nodes.NodeMaker}s for subject, predicate and object
 * to each result row. This is implemented as a stateless wrapper around a
 * {@link de.fuberlin.wiwiss.d2rq.algebra.NodeRelation}.
 *
...
public class TripleRelation extends NodeRelation {
	...
	/**
	 * Creates a {@link de.fuberlin.wiwiss.d2rq.algebra.NodeRelation} by applying a triple pattern
	 * to the TripleRelation. If the triple contains variables, then
	 * the variables will be bound to the corresponding values
	 * in the resulting NodeRelation. {@link com.hp.hpl.jena.graph.Node#ANY} will be
