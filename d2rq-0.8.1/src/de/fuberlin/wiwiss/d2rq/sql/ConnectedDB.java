...
/**
 * TODO Move all engine-specific code from here to {@link de.fuberlin.wiwiss.d2rq.sql.vendor.Vendor} and its implementations
 * 
...
public class ConnectedDB {
	 ...
	 * @param driverClassName Fully qualified class name of a JDBC driver
	 * @throws de.fuberlin.wiwiss.d2rq.D2RQException If the class could not be found
	 */
