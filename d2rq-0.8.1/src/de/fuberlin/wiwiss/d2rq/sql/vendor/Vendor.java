...
public interface Vendor {
	 ...
	 * 
	 * @param limit A maximum number of rows, or {@link de.fuberlin.wiwiss.d2rq.map.Database#NO_LIMIT}
	 * @return An expression that limits the number of rows, or {@link de.fuberlin.wiwiss.d2rq.expr.Expression#TRUE}
	...
	/**
	 * Returns a {@link de.fuberlin.wiwiss.d2rq.sql.types.DataType} corresponding to a JDBC type. This may be
	 * an unsupported datatype; in this case, its {@link de.fuberlin.wiwiss.d2rq.sql.types.DataType#isUnsupported()}
