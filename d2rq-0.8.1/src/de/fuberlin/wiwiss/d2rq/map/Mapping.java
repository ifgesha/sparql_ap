...
/**
 * A D2RQ mapping. Consists of {@link de.fuberlin.wiwiss.d2rq.map.ClassMap}s,
 * {@link de.fuberlin.wiwiss.d2rq.map.PropertyBridge}s, and several other classes.
 * 
...
public class Mapping {
	 ...
	 * earlier.
	 * 
	 * @throws de.fuberlin.wiwiss.d2rq.D2RQException on connection failure
	 */
	public void connect() {
		if (connected) return;
		connected = true;
	...
	/**
	 * @return A collection of {@link de.fuberlin.wiwiss.d2rq.algebra.TripleRelation}s corresponding to each
