...
public class GraphD2RQ extends GraphBase implements Graph {
	...
	/**
	 * Creates a new D2RQ graph from a previously prepared {@link de.fuberlin.wiwiss.d2rq.map.Mapping} instance.
	 * @param mapping A D2RQ mapping
	 * @throws de.fuberlin.wiwiss.d2rq.D2RQException If the mapping is invalid
	 */
	...
	/**
	 * @return The {@link de.fuberlin.wiwiss.d2rq.map.Mapping} this graph is based on
	 */
