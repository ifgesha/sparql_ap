 ...
 *
 * <p>This class is a thin wrapper around a {@link de.fuberlin.wiwiss.d2rq.jena.GraphD2RQ} and provides only
...
public class ModelD2RQ extends ModelCom implements Model {
	...
	/**
	 * @return The underlying {@link de.fuberlin.wiwiss.d2rq.jena.GraphD2RQ}
	 */
	@Override
