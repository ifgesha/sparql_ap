...
/**
 * An implementation of Jena's {@link com.hp.hpl.jena.graph.query.QueryHandler} interface
 * that answers BGP queries on behalf of a {@link de.fuberlin.wiwiss.d2rq.jena.GraphD2RQ}.
 * This is here for Jena compatibility, and is not involved
 * in answering SPARQL queries through ARQ. It uses the
 * {@link de.fuberlin.wiwiss.d2rq.engine.QueryEngineD2RQ} to answer BGP queries and wraps
